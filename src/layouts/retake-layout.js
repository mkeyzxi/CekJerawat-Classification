class RetakeLayout extends HTMLElement {
	...
	render() {
		this.innerHTML = `
	<main class="flex-grow flex flex-col items-center justify-center px-4 sm:px-6 md:px-8 text-center mt-12 max-w-md sm:max-w-lg mx-auto">
  <h2 class="text-pink-400 text-xl sm:text-2xl font-bold mb-8 drop-shadow-[0_0_4px_rgba(255,182,193,0.7)]">
  ...
  <div class="bg-pink-300 rounded-3xl p-6 flex justify-center items-center w-56 sm:w-64 h-56 sm:h-64 mb-8">
    <img
