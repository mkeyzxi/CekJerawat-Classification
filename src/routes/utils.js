...
export function renderPage() {
  ...
  if (!match) {
    // tampilkan halaman 404 jika tidak cocok
    app.innerHTML = `
      <section class="flex flex-col items-center justify-center min-h-screen bg-white text-center px-4">
  ...
  try {
    ...
    if (typeof page.render === 'function') {
      // tambahkan animasi fade-out sebelum mengganti halaman
